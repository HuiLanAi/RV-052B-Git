...
#
# Generated by export_simulation on Mon Jun 29 23:14:12 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './cmp_u.sh' script.
...
./cmp_u.sh -noclean_files

For more information on the script, please type './cmp_u.sh -help'.
