...
#
# Generated by export_simulation on Tue Jul 07 00:46:39 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './int2flt.sh' script.

./int2flt.sh -reset_run
...
./int2flt.sh -noclean_files

For more information on the script, please type './int2flt.sh -help'.
