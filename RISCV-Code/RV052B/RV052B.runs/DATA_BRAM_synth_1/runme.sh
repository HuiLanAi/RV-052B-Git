...
HD_PWD='C:/Users/Administrator/Desktop/RV-052B/RISCV-Code/RV052B/RV052B.runs/DATA_BRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DATA_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DATA_BRAM.tcl
