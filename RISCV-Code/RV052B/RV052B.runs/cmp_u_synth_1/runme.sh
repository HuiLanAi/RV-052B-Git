...
HD_PWD='C:/Users/Administrator/Desktop/RV-052B/RISCV-Code/RV052B/RV052B.runs/cmp_u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmp_u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cmp_u.tcl
