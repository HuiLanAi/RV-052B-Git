...
HD_PWD='C:/Users/Administrator/Desktop/RV-052B/RISCV-Code/RV052B/RV052B.runs/addsub_no_u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub_no_u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addsub_no_u.tcl
